...
import r4d from '../../assets/r4d.PNG'
...
const Hero = () => {
  return (
    <HeroSection>
      <HeroContent>
        <HeroTitle>Research Information & Technology Generated by R&D</HeroTitle>
      </HeroContent>
    </HeroSection>
  );
};
...
function Page() {
  ...
  const [cards] = useState([
    {
      title: "Seed Preference for Rice Farmers Across Different Ecosystem in Region 02",
      text: "Prepared by Research Division",
      imageSrc: farmers,
      powerBIUrl:
        "https://app.powerbi.com/view?r=eyJrIjoiNTRmN2Y3ZmQtYmQ3Yy00MzI0LTlmODQtZDQwMTUzZTBmOGIwIiwidCI6IjY4OTgwNjFkLTFhNmItNGUzOS1hZGZjLWRjOGFmZTA3MjIwMSIsImMiOjEwfQ%3D%3D",
    },
    {
        title: "R4D Technology Transfer and Research Knowledge Database",
        text: "Prepared by Research Division",
        imageSrc: r4d,
        powerBIUrl:
          "https://app.powerbi.com/view?r=eyJrIjoiNjA1MmUzNTctNjViYi00MTUxLWI3NTQtMmQyOTQ3YTJlZTRhIiwidCI6IjY4OTgwNjFkLTFhNmItNGUzOS1hZGZjLWRjOGFmZTA3MjIwMSIsImMiOjEwfQ%3D%3D",
      },
      {
        title: "Seed Preference of Corn Farmers Across Different Development Zones in R02",
        text: "Prepared by Research Division",
        imageSrc: three,
        powerBIUrl:
          "https://app.powerbi.com/view?r=eyJrIjoiZDU1MDQzMDctNmM1NS00MDA5LWE4MWUtODE1NTBjOTdjZGJlIiwidCI6IjY4OTgwNjFkLTFhNmItNGUzOS1hZGZjLWRjOGFmZTA3MjIwMSIsImMiOjEwfQ%3D%3D",
      },
  ]);
